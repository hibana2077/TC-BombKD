...
#     --loss_bar 0.0 \
#     --loss_l1 0.0 \
#     --save_dir ./checkpoints/U058 >> U058.log 2>&1
...
#     --student vjepa2 \
#     --teachers videomae timesformer vivit \
#     --converters ./checkpoints/U058/converters_ep10.pt \
#     --classes 101 \
#     --frames 16 \
#     --batch 8 \
#     --epochs 50 \
...
for ep in {1..50}; do
  echo "checkpoint: ep$ep" >> U058E.log 2>&1
  ...
  --root ./features/features_ucf101_test.index.json \
    ...
    --teachers videomae timesformer vivit \
    --converters ./checkpoints/U058/converters_ep10.pt \
    --fusion ./checkpoints/U058/fusion_ep$ep.pt \
    --features_fp16 \
    --use_cached_features \
    --frames 16 >> U058E.log 2>&1
done