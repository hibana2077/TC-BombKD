...
python3 -m polyspace.train.inspect_features --features ./features/hmdb51/features_hmdb51_test.index.json --limit 100 --sample 3 --report-anormaly >> H000ITT.log 2>&1
