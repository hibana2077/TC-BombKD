...
try:
    ...
    from .datasets import HMDB51Dataset, Diving48Dataset, SSv2Dataset, BreakfastDataset, UCF101Dataset, UAVHumanDataset, collate_fn
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", type=str, required=True, choices=["hmdb51", "diving48", "ssv2", "breakfast", "ucf101", "uav"]) 
